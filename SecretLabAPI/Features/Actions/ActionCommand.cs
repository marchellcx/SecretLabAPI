...
namespace SecretLabAPI.Features.Actions
{
    /// <summary>
    ...
    {
        [CommandOverload("reload", "Reloads the global action table.", "action.reload")]
        private void Reload()
        {
        ...
        [CommandOverload("actions", "Lists all registered actions.", "actions.actions")]
        ...
        [CommandOverload("action", "Shows detailed information about an action.", "action.action")]
        ...
        [CommandOverload("tables", "Lists all loaded action tables by group.", "action.tables")]
        private void Tables()
        {
        ...
        [CommandOverload("table", "Shows a detailed description of a table.", "action.table")]
        ...
        [CommandOverload("run", "Runs a table.", "action.run")]
        private void Run(
        ...
        [CommandOverload("invoke", "Attempts to parse and invoke an action expression.", "action.invoke")]
        private void Invoke(
