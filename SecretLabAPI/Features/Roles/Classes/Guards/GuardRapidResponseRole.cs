...
/// <summary>
/// Represents the Rapid Response Guard role, which is a specialized spawnable role for facility guards.
/// This role is designed to handle emergency situations with increased mobility and specific equipment.
/// </summary>
public class GuardRapidResponseRole : SpawnableCustomRole
{
    /// <inheritdoc/>
    public override string Id { get; } = "guard_rr";

    /// <inheritdoc/>
    public override string Name { get; set; } = "Rapid Response";
