...
namespace SecretLabAPI.Features.Misc
{
    ...
    public static class Scp914Teleport
    {
        ...
        /// </summary>
        [Config("scp914Teleport", "scpChance", "Chance that a player will be teleported to an SCP during SCP-914 teleportation.")]
        ...
        [Config("scp914Teleport", "zones", "Mapping of facility zones to the minimum round duration, in seconds, required for SCP-914 teleportation to be enabled in each zone.")]
        ...
        private static void OnMapGenerated(MapGeneratedEventArgs args)
        {
            ...
            if (Lcz914Room == null)
                ...
                ApiLog.Debug("Scp914Teleport", $"LCZ-914 room found at &1{Lcz914Room.WorldspaceBounds.center.ToPreciseString()}&r.");
        }
